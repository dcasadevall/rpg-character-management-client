...
export default function FinalizeCurrency() {
    ...
    return (
        <div className="max-w-6xl mx-auto py-8">
            <h1 className="text-3xl font-bold mb-8 text-center">Your Character is Created!</h1>
                ...
                <div className="md:flex">
                    ...
                    <div className="md:w-2/3 p-6">
                        ...
                        <div className="mb-8 bg-gray-50 p-6 rounded-lg border border-gray-200">
                            <h3 className="text-lg font-medium mb-4 border-b pb-2">Starting Gold</h3>

                            {rollingGold ? (
                                <div className="flex flex-col items-center py-4">
                                    <div className="animate-bounce text-3xl mb-2">🎲</div>
                                    <p className="text-lg font-medium">Rolling for gold...</p>
                                    <p className="text-sm text-gray-600 mt-2">Determining your character's starting wealth</p>
                                </div>
                            ) : gold !== null ? (
                                <div className="flex items-center justify-center py-4">
                                    <div className="bg-yellow-100 text-yellow-800 px-6 py-3 rounded-full flex items-center text-xl">
                                ...
                                <div className="flex items-center justify-center py-4">
                                    <p className="text-gray-500">Gold amount could not be determined</p>
                                </div>
                            )}
                        </div>
